...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'companyID', GxHtml::listDataEx(Company::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model, 'stockCount'); ?>
		<?php echo $form->textField($model, 'stockCount', array('maxlength' => 20)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'transitCount'); ?>
